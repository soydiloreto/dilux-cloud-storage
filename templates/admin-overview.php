            ...
            <div id="stats-content">
                ...
                <?php else:
                    ...
                    $dilux_bar_color = function(float $pct, bool $exceeded = false): array {
                        if ($exceeded) return ['color' => '#d63638', 'bg' => '#f8d7da'];
                        if ($pct >= 80) return ['color' => '#dba617', 'bg' => '#fff3cd'];
                        return ['color' => '#00a32a', 'bg' => '#d1e7dd'];
                    };
                        ...
                        <div class="dilux-files-grid">
                            ...
                            <div class="dilux-pie-container" id="stat-pie-section">
                                ...
                                <div class="dilux-pie-legend">
                                    <div class="dilux-legend-item"><span class="dilux-legend-dot" style="background: #2271b1;"></span><?php
                                    ...
                                    ?></div>
                                    <div class="dilux-legend-item"><span class="dilux-legend-dot" style="background: #d63638;"></span><?php
                                        /* translators: 1: number of files, 2: percentage */
                                        echo esc_html(sprintf(__('Videos %1$s (%2$s%%)', 'dilux-cloud-storage'), number_format_i18n($files_by_type['videos'] ?? 0), $pct_videos));
                                    ?></div>
                                    <div class="dilux-legend-item"><span class="dilux-legend-dot" style="background: #dba617;"></span><?php
                                        /* translators: 1: number of files, 2: percentage */
                                        echo esc_html(sprintf(__('Audio %1$s (%2$s%%)', 'dilux-cloud-storage'), number_format_i18n($files_by_type['audio'] ?? 0), $pct_audio));
                                    ?></div>
                                    <div class="dilux-legend-item"><span class="dilux-legend-dot" style="background: #8c8f94;"></span><?php
                                        /* translators: 1: number of files, 2: percentage */
